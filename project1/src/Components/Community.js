...
const Community = () => {
  return (
    <div className="CommunityContainer">
      <div>
        <h2>Events</h2>
        <h3>Sponshorship and Collaborations.</h3>
        <h3>Campus Ambossdar Program. </h3>
      </div>

      <div>
        <h1 className="text-align">Upcoming Events </h1>
        <div className="innerContainer">
          <img
            src="https://files.codingninjas.in/coding-event-mobile-27234.jpg"
            alt=""
          />
          <br />
          <br />
          <img
            src="https://files.codingninjas.in/bitblitz-mobile-27825.png"
            alt=""
          />
        </div>
        <div className="innerContainer">
      ...
      <div className="pastevents">
        ...
        <h5>PAST EVENTS </h5>
        <h6>PAT || KPIUT || SHRI RAM GROUP JABALPUR</h6>
        <h6>ROADMOAP TO DSE  ||  IEEE  MUJ</h6>
        <h6>Coding Ninjas Prsent BCA Coding Test || future Institute Of Engineering Technology</h6>
        <h6>Dev Spark IEEE - WIE and IEEE IAS (VIT VELLORE ) </h6>
      </div>
